...
= YJ Schema Validator
:description: CLI to validate YAML and JSON against JSON Schema (Draft 2019-09 and 2020-12), with colored, JSON, or JUnit output for CI pipelines.
...
- *STDIN Support*: Pipe content directly to the validator using `stdin` or `-` filename.
