...
* link:https://alexmond.github.io/yj-schema-validator/current/_attachments/yj-schema-validator-config.yaml[YAML Schema^]
* link:https://alexmond.github.io/yj-schema-validator/current/_attachments/yj-schema-validator-config.json[JSON Schema^]
